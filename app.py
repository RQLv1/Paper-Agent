...
with gr.Blocks() as demo:
    ...
    with gr.Accordion("📖 Table of Contents", open=False):
        toc_image = gr.Image(
            value=os.path.join(APP_DIR, "ToC.png"),  # 确保图片路径正确
            ...
            with gr.Tab("Paper platform"):
                ...
                with gr.Row():
                    spg_key = gr.Textbox(
                        label="Springer Key",
                        type="password",
                        value="d0356e07-540d-4cc7-b44c-1e2b4fe52ec4"
                    )
                    els_key = gr.Textbox(
                        label="Elsevier Key",
                        type="password",
                        value="a6e76b4924eed975fa82c1fac6ecbc7c"
                    )
                    wly_key = gr.Textbox(
                        label="Wiley Key",
                        type="password",
                        value="6c26c289269b26fd89259f5967ceafd5"
                    )
                    ...
                    data_analysis_key = gr.Textbox(
                        ...
                        type="password",
                        value="sk-bcc39a2fd1ec4aaf81bb672f446d1b2d"
                    )
