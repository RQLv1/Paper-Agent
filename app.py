...
def create_tools(spg_key, 
    ...
    from functions.create_database import Create_db
    from functions.clean_database import Clean_db
    from functions.vector_store import VectorStore
    from functions.data_extract import DataExtractor
    from functions.data_count import DataCount
    from functions.data_analysis import FeatureExtractor
    from functions.model_sel import ModelSelector
    from functions.shapplot import Shapplot
...
with gr.Blocks() as demo:
    ...
    with gr.Accordion("📖 Table of Contents", open=False):
        toc_image = gr.Image(
            value=os.path.join(APP_DIR, "images", "ToC.png"),
